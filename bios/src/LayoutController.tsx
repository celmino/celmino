import { Models, Query, useDeleteSessions, useGetMe, useGetProject, useListProjects, useListTeams } from "@realmocean/sdk";
                ...
                VStack(
                    ...
                    HStack({ alignment: cLeading })(
                                    ...
                                    UIWidget('com.tuvalsoft.widget.topdropdown')
                                        .config({
                                            ...
                                            onClick: (selectedItem) => {
                                                ...
                                                navigate(`/organization/${selectedItem.value}`)
                        ...
                        HStack(
                            UIViewBuilder(() => {
                                const [team, setTeam] = useLocalStorage('teamId', null);
                                const { project }: { project: Models.Project } = useGetProject(project_id, (team_id == null && project_id != null));
    
                                const { projects } = useListProjects((team != null || project?.teamId != null), [
                                    Query.equal('teamId', team ?? project?.teamId)
                                ]);
                                    ...
                                    UIWidget('com.tuvalsoft.widget.topdropdown')
                                        .config({
                                            ...
                                            onClick: (selectedItem) => {
                                                ...
                                                navigate(`/workspace/${selectedItem.value}`)
                                                /* setTeam({
