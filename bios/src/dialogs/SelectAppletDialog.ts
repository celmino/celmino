import { Button, ButtonSize, ButtonType, DialogView, ForEach, HStack, Heading, Icon, Icons, ScrollView, Text, UIImage, UIView, VStack, ViewProperty, cCenter, cLeading, cTopLeading, cVertical, useParams, useState } from "@tuval/forms";
