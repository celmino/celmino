...
var MyTestController = /** @class */ (function (_super) {
    ...
    MyTestController.prototype.LoadView = function () {
        ...
        //TaskTable2(tasks, taskStageSet.stages)
        (0,_tuval_forms__WEBPACK_IMPORTED_MODULE_0__.Text)('sadsa'), (0,_tuval_forms__WEBPACK_IMPORTED_MODULE_0__.UIWidget)('com.tuvalsoft.widget.list')
            .config({
            onItemClick: function (item) { return alert(JSON.stringify(item)); },
            items: [
                {
                    $id: 'Item1',
                    name: 'Mert_',
...
//# sourceMappingURL=index.js.map
                    tuval$core.ModuleLoader.FireModuleLoadedEvent('com.celmino.view.list', tuval$core['__APPS__']['com.celmino.view.list']);
